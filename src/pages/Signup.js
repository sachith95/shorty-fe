...
const Signup = (props) => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      toast.success("Registering successfully! Redirect to sign in page ...", {
        autoClose: 1000,
      });
      setTimeout(function () {
      ...
      toast.error("Something wrong, please try again or another email", {
        autoClose: 1000,
      });
    }
  };
  ...
  return (
    <Layout>
      <div className="userForm">
        ...
        >
          <div className="userForm__container__title">Sign up</div>
